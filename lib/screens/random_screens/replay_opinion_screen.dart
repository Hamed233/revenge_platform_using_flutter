...
class ReplayOnOpinionScreen extends StatelessWidget {
  const ReplayOnOpinionScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Replies on opinion'),
        titleSpacing: 0,
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const AddOpinionBox(hintText: "write replay..."),
          ],
        ),
      ),
    );
      ...
      children: <Widget>[
        Container(
          ...
          child: GestureDetector(
            child: CircleAvatar(
              radius: radius,
              backgroundImage: NetworkImage('https://yt3.ggpht.com/ytc/AAUvwnjcXhQ1Tl-tCyXrovuQwBMHrFwE9uMzzclq2SzHjg=s176-c-k-c0xffffffff-no-rj-mo'),
            ),
          ),
