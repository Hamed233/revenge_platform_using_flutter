                ...
                title: InkWell(
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        radius: 20.0,
                        backgroundImage: widget.userModel!.image != '' ? NetworkImage(widget.userModel!.image!) : null,
                        child: widget.userModel!.image == '' ? Text(widget.userModel!.fullName!.substring(0, 1).toUpperCase()) : null,
                      ),
                      SizedBox(
                        width: 15.0,
                      ),
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "hamed, alaa, noor, ahmed, ali, mona, ...",
