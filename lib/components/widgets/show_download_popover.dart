...
import 'package:revenge_platform/providers/remember_choice.dart';
import 'package:revenge_platform/providers/thumbnail_downloader.dart';
...
//   Future<Video> getVideo() => videos.get(videoUrl);
...
//                 manifest: youtube_explode.manifest,
//               )
//             : snapshot.hasError
//                 ? Text("error")
//                 : _progressIndicator;
    ...
    return SafeArea(
      child: FutureBuilder<StreamManifest>(
        ...
        builder: (context, snapshot) {
          ...
          return 
          // snapshot.hasData || manifest != null ? 
              Column(
