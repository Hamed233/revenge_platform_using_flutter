    ...
    _controller = BetterPlayerController(
      BetterPlayerConfiguration(
        ...
        controlsConfiguration: BetterPlayerControlsConfiguration(
          overflowModalColor: Theme.of(context).backgroundColor.withOpacity(0.9),
          overflowMenuIconsColor: Theme.of(context).textTheme.bodyText1!.color!,
          overflowModalTextColor: Theme.of(context).textTheme.bodyText1!.color!,
          playIcon: Icons.play_arrow,
          playerTheme: BetterPlayerTheme.material,
          loadingWidget: const CircularProgressIndicator(),
          progressBarPlayedColor: Theme.of(context).primaryColor.withOpacity(0.92),
